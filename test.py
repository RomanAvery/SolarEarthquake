...
columns = [
    ...
    "Decimal Day",  # 2
    "Hour",  # 3
    "Bartels rotation number",  # 4
    "ID for IMF spacecraft",   # 5
    "ID for SW plasma spacecraft",   # 6
    "# of points in the IMF averages",   # 7
    "# of points in the plasma averages",   # 8
    "Field Magnitude Average |B|",   # 9
    "Magnitude of Average Field Vector",   # 10
    "Lat.Angle of Aver. Field Vector",   # 11
    "Long.Angle of Aver. Field Vector",   # 12
    "Bx GSE, GSM",   # 13
    "By GSE",   # 14
    "Bz GSE",   # 15
    "By GSM",   # 16
    ...
    "sigma By",   # 21
    "sigma Bz",   # 22
    "Proton temperature",   # 23
    "Proton density",   # 24
    "Plasma (Flow) speed",   # 25
    "Plasma Flow Long. Angle",   # 26
    "Plasma Flow Lat. Angle",   # 27
    "Na/Np",   # 28
    "Flow Pressure",   # 29
    "sigma T",   # 30
    "sigma N",   # 31
    ...
    "Electric field",   # 36
    "Plasma beta",   # 37
    "Alfven mach number",   # 38
    "Kp",   # 39
    "R",   # 40
    "DST Index",   # 41
    "AE-index",   # 42
    "Proton flux >1 MeV",   # 43
    "Proton flux >2 MeV",   # 44
    "Proton flux >4 MeV",   # 45
    "Proton flux >10 MeV",   # 46
    "Proton flux >30 MeV",   # 47
    "Proton flux >60 MeV",   # 48
    "Flag(***)",   # 49
    "ap-index",   # 50
    "f10.7_index",   # 51
    "PC(N) index",   # 52
    "AL-index, from Kyoto",   # 53
    "AU-index, from Kyoto",   # 54
    "Magnetosonic mach number",   # 55
    
]

omni2 = pd.read_table('data/omni2_all_years.dat.txt', sep='\s+', names=columns)

pd.DataFrame.plot(omni2)

#omni2.to_excel("omni2_all_years.xlsx", sheet_name="omni2", index=False)
